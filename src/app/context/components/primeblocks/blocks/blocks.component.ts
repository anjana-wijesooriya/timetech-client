...
<div class="grid grid-cols-12 gap-4 grid-nogutter bg-surface-0 dark:bg-surface-950 text-surface-800 dark:text-surface-50">
    <div class="col-span-12 md:col-span-6 p-12 text-center md:text-left flex items-center ">
        <section>
            ...
            <div class="text-6xl text-primary font-bold mb-4">visitors deserve to see</div>
            ...
            <button pButton pRipple label="Learn More" type="button" class="mr-4 p-button-raised"></button>
    ...
    <div class="col-span-12 md:col-span-6 overflow-hidden">
        <img src="assets/context/images/blocks/hero/hero-1.png" alt="Image" class="md:ml-auto block md:h-full" style="clip-path: polygon(8% 0, 100% 0%, 100% 100%, 0 100%)">
    </div>
</div>`;
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="p-4 h-full">
                <div class="shadow p-4 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                    ...
                    <button pButton pRipple label="Buy Now" class="p-4 w-full mt-auto"></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="p-4 h-full">
                <div class="shadow p-4 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                    ...
                    <button pButton pRipple label="Buy Now" class="p-4 w-full"></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="p-4 h-full">
                <div class="shadow p-4 flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                    ...
                    <hr class="mb-4 mx-0 border-t border-0 border-surface" />
                    <button pButton pRipple label="Buy Now" class="p-4 w-full p-button-outlined"></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="bg-surface-0 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20">
    <div class="text-surface-700 dark:text-surface-100 text-center">
        ...
        <button pButton pRipple label="Join Now" icon="pi pi-discord" class="font-bold px-8 py-4 p-button-raised p-button-rounded whitespace-nowrap"></button>
    </div>
</div>`;
...
<div class="bg-slate-900 text-gray-100 p-4 flex justify-between lg:justify-center items-center flex-wrap">
    ...
    <a pRipple class="flex items-center no-underline justify-center rounded-full text-gray-50 hover:bg-slate-700 cursor-pointer transition-colors duration-150" style="width:2rem; height: 2rem">
...
<div class="bg-surface-0 dark:bg-surface-900 p-6 shadow rounded-border w-full lg:w-6/12">
    <div class="text-center mb-8">
        <img src="assets/context/images/blocks/logos/hyper.svg" alt="Image" height="50" class="mb-4">
    ...
    <div>
        ...
        <input id="email1" type="text" pInputText class="w-full mb-4">

        <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium mb-2">Password</label>
        <input id="password1" type="password" pInputText class="w-full mb-4">
